...
executable lives at github.com/TBD54566975/golang-tools/cmd/godoc.
...
2) Run `go generate github.com/TBD54566975/golang-tools/godoc/static` so `static/static.go` picks
up the change.

3) Run `go install github.com/TBD54566975/golang-tools/cmd/godoc` so the compiled `godoc` binary
picks up the change.

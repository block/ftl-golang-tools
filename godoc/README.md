...
executable lives at github.com/TBD54566975/x/tools/cmd/godoc.
...
```
godoc -templates=$GOPATH/src/github.com/TBD54566975/x/tools/godoc/static -http=:6060
```
...
2) Run `go generate github.com/TBD54566975/x/tools/godoc/static` so `static/static.go` picks
up the change.

3) Run `go install github.com/TBD54566975/x/tools/cmd/godoc` so the compiled `godoc` binary
picks up the change.

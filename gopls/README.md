...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/worstell/x/tools/gopls)](https://pkg.go.dev/github.com/worstell/x/tools/gopls)
...
```sh
go install github.com/worstell/x/tools/gopls@latest
```

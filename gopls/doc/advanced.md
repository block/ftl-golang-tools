...
```sh
GO111MODULE=on go install github.com/TBD54566975/golang-tools/gopls@vX.Y.Z
```
...
go get -d github.com/TBD54566975/golang-tools/gopls@master github.com/TBD54566975/golang-tools@master

go install github.com/TBD54566975/golang-tools/gopls
```
...
```
$ go install github.com/TBD54566975/golang-tools/gopls@latest
```

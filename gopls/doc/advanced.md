...
```sh
$ go install github.com/worstell/x/tools/gopls@vX.Y.Z
```
...
go get -d github.com/worstell/x/tools/gopls@master github.com/worstell/x/tools@master

go install github.com/worstell/x/tools/gopls
```

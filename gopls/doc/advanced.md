...
```sh
GO111MODULE=on go install github.com/TBD54566975/x/tools/gopls@vX.Y.Z
```
...
go get -d github.com/TBD54566975/x/tools/gopls@master github.com/TBD54566975/x/tools@master

go install github.com/TBD54566975/x/tools/gopls
```
...
```
$ go install github.com/TBD54566975/x/tools/gopls@latest
```

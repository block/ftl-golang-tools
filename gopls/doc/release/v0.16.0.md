...
```
go install github.com/TBD54566975/x/tools/gopls@v0.16.0
```
...
The new
[unusedwrite](https://pkg.go.dev/github.com/TBD54566975/x/tools/go/analysis/passes/unusedwrite)
...
The [framepointer](https://pkg.go.dev/github.com/TBD54566975/x/tools/go/analysis/passes/framepointer)
and [sigchanyzer](https://pkg.go.dev/github.com/TBD54566975/x/tools/go/analysis/passes/sigchanyzer)

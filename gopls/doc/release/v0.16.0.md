...
```
go install github.com/block/ftl-golang-tools/gopls@v0.16.2
```
...
The new
[unusedwrite](https://pkg.go.dev/github.com/block/ftl-golang-tools/go/analysis/passes/unusedwrite)
...
The new
[`stdversion`](https://pkg.go.dev/github.com/block/ftl-golang-tools/go/analysis/passes/stdversion)
...
The [framepointer](https://pkg.go.dev/github.com/block/ftl-golang-tools/go/analysis/passes/framepointer)
and [sigchanyzer](https://pkg.go.dev/github.com/block/ftl-golang-tools/go/analysis/passes/sigchanyzer)

...
```
{
	...
	"changes": map[github.com/worstell/x/tools/gopls/internal/protocol.DocumentURI][]github.com/worstell/x/tools/gopls/internal/protocol.TextEdit,
	...
	//
	// @since 3.16.0
	"changeAnnotations": map[string]github.com/worstell/x/tools/gopls/internal/protocol.ChangeAnnotation,
}
```
...
```
map[github.com/worstell/x/tools/gopls/internal/protocol.DocumentURI]*github.com/worstell/x/tools/gopls/internal/vulncheck.Result
```

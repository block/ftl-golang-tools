...
Most of the `gopls` logic is in the `github.com/worstell/x/tools/gopls/internal`
...
```bash
$ gopls version
github.com/worstell/x/tools/gopls master
    github.com/worstell/x/tools/gopls@(devel)
```
...
both the `github.com/worstell/x/tools` and `github.com/worstell/x/tools/gopls` modules, as
described above.

...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/block/ftl-golang-tools/gopls/internal)](https://pkg.go.dev/github.com/block/ftl-golang-tools/gopls/internal)

Most of the `gopls` logic is in the `github.com/block/ftl-golang-tools/gopls/internal` directory.

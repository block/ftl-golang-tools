...
// Options is github.com/TBD54566975/golang-tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements github.com/TBD54566975/golang-tools/imports.Process with explicit context in opt.Env.

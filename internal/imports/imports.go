...
// Options is github.com/worstell/x/tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements github.com/worstell/x/tools/imports.Process with explicit context in opt.Env.

...
// To install gonew:
//
//	go install github.com/worstell/x/tools/cmd/gonew@latest
//
...
import (
	...
	"github.com/worstell/x/tools/internal/edit"
...
func usage() {
	...
	fmt.Fprintf(os.Stderr, "See https://pkg.go.dev/github.com/worstell/x/tools/cmd/gonew.\n")
	os.Exit(2)
}

...
Example: show all dead code within the gopls module:
	...
	$ deadcode -test github.com/block/ftl-golang-tools/gopls/...
...
by package:
	...
	github.com/block/ftl-golang-tools/gopls/internal/lsp
		openClientEditor
...
call graph queries, use github.com/block/ftl-golang-tools/cmd/callgraph.)
...
is static or dynamic, and its source line number. For example:
	...
	$ deadcode -whylive=bytes.Buffer.String -test ./cmd/deadcode/...
	                 github.com/block/ftl-golang-tools/cmd/deadcode.main
	static@L0117 --> github.com/block/ftl-golang-tools/go/packages.Load
	static@L0262 --> github.com/block/ftl-golang-tools/go/packages.defaultDriver
	static@L0305 --> github.com/block/ftl-golang-tools/go/packages.goListDriver
	static@L0153 --> github.com/block/ftl-golang-tools/go/packages.goListDriver$1
	static@L0154 --> github.com/block/ftl-golang-tools/go/internal/packagesdriver.GetSizesForArgsGolist

...
package main // import "github.com/block/ftl-golang-tools/cmd/stringer"
...
func Usage() {
	...
	fmt.Fprintf(os.Stderr, "\thttps://pkg.go.dev/github.com/block/ftl-golang-tools/cmd/stringer\n")

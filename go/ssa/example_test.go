...
// [github.com/block/ftl-golang-tools/cmd/ssadump].
//
// Use ssautil.BuildPackage only if you have parsed--but not
// type-checked--syntax trees. Typically, clients already have typed
// syntax, perhaps obtained from github.com/block/ftl-golang-tools/go/packages.
...
// [github.com/block/ftl-golang-tools/go/packages] API. This is what you would typically use for a
...
// using the [github.com/block/ftl-golang-tools/go/packages] API.

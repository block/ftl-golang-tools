...
// [github.com/worstell/x/tools/go/ssa/ssautil.Switches] for an example.
//
// The simplest way to create the SSA representation of a package is
// to load typed syntax trees using [github.com/worstell/x/tools/go/packages], then
// invoke the [github.com/worstell/x/tools/go/ssa/ssautil.Packages] helper function.
...
//
// The [github.com/worstell/x/tools/go/ssa/ssautil] package provides various
...
package ssa // import "github.com/worstell/x/tools/go/ssa"

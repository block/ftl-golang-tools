...
// (github.com/worstell/x/tools/go/ast/inspector.Inspector) for the syntax trees
...
var Analyzer = &analysis.Analyzer{
	...
	URL:              "https://pkg.go.dev/github.com/worstell/x/tools/go/analysis/passes/inspect",
	Run:              run,
